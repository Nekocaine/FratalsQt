...
Vicsek45::Vicsek45()
{
    name = "Fractale de Vicsek à 45°";   //nom
...
void it4(QPainter &painter,QBrush &brush, int cx1, int cy1, int cx2, int cy2,int cx3,int cy3,int cx4,int cy4, int its) {
    ...
    if (its > 0) {
        ...
        int cix4 = cx2;
        int ciy4 = cy3;
        //appel de la fonction sur tout les carres de la croix à 45°
        it4(painter,brush,cix1,ciy1,cix2,ciy1,cix1,ciy2,cix2,ciy2,its-1);
        it4(painter,brush,cix3,ciy1,cix4,ciy1,cix3,ciy2,cix4,ciy2,its-1);
        it4(painter,brush,cix2,ciy2,cix3,ciy2,cix2,ciy3,cix3,ciy3,its-1);
        it4(painter,brush,cix1,ciy3,cix2,ciy3,cix1,ciy4,cix2,ciy4,its-1);
        it4(painter,brush,cix3,ciy3,cix4,ciy3,cix3,ciy4,cix4,ciy4,its-1);
...
void Vicsek45::gen(QImage &img, const QString &its_str, const QColor &fg, const QColor &bg) const {
    ...
    it4(painter,brush,cx1, cy1, cx2, cy2, cx3, cy3, cx4, cy4, its);//appel de la fonction recursive
